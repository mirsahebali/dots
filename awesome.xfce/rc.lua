...
globalkeys = my_table.join(
	...
	awful.key({ modkey, "Shift" }, "-", function()
		awful.spawn.with_shell("killall -9 polybar", false)
		awful.spawn.with_shell("killall -9 xfce4-panel", false)
	end, { description = "hide panel", group = "awesome" }),

	awful.key({ modkey, "Shift" }, "=", function()
		awful.spawn.with_shell("$HOME/.config/polybar/forest/launch.sh", false)
		awful.spawn.with_shell("xfce4-panel &", false)
	end, { description = "hide panel", group = "awesome" }),
	awful.key({ modkey, altkey }, "m", function()
		awful.spawn("firefox -P Music")
	end, { description = "Firefox Music", group = "Super + Alt" }),
	...
	awful.key({ modkey }, "e", function()
		awful.util.spawn(filemanager)
	end, { description = "Thunar", group = "super" }),
	...
	end, { description = "dropdown terminal", group = "super" }),
	awful.key({ modkey }, "v", function()
		awful.util.spawn("xfce4-clipman-history")
	...
	--NOTE: ctrl+alt Keybinds  ...
	awful.key({ modkey1, altkey }, "n", function()
		local isRunning = os.execute("pgrep redshift")
		if isRunning then
			awful.util.spawn("kill -9 $(pgredp redshift)", false)
		end
		awful.util.spawn("redshift -l 26.12:91.65 &", false)
	end, { description = "Redshift", group = "alt+ctrl" }),
	...
	awful.key({ modkey, "Shift" }, "n", function()
		-- lain.util.add_tag()
		awful.spawn.with_shell("kitty nvim", false)
	...
	awful.key({ modkey, "Shift", altkey }, "h", function()
		awful.tag.incnmaster(1, nil, true)
	end, { description = "increase the number of master clients", group = "layout" }),
	awful.key({ modkey, "Shift", altkey }, "l", function()
		awful.tag.incnmaster(-1, nil, true)
	...
	awful.key({ altkey, modkey, "Control" }, "x", function()
		awful.prompt.run({
			prompt = "Run Lua code: ",
...
awful.rules.rules = {
	...
	{ rule = { class = "firefox" }, properties = { screen = 1, tag = awful.util.tagnames[9], switchtotag = true } },

	{ rule = { class = "nvim" }, properties = { screen = 1, tag = awful.util.tagnames[2], switchtotag = true } },

	{ rule = { class = "Emacs" }, properties = { screen = 1, tag = awful.util.tagnames[4], switchtotag = true } },
