...
sudo pacman -s git clang neovim gvim emacs curl \
	...
	ninja lxappearance linux-headers hyprpicker gtk3 gtk2 dolphin dkms dbus bluedevil base \
	autorandr arandr alligator sddm okular network-manager-applet ncurses figlet

yay -S hyprland-git gopls goimports gofumpt yank wireplumber unzip swaybg swaync rustywind hyprpicker brave-bin \
	ttf-apple-emoji ttf-nerd-fonts-symbols-common ttf-jetbrains-mono-nerd goimports-reviser go-impl
